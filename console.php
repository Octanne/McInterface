...
<html>
  <head>
    ...
    <title><?php echo $name ?> | Console</title>
    ...
    <div id="consoleRow">
      <div class="panel panel-default" id="consoleContent">
        <div class="panel-heading">
          <h3 class="panel-title pull-left"><span class="glyphicon glyphicon-console"></span> Console | <?php echo $name ?></h3>
          <div class="btn-group btn-group-xs pull-right">
			...
			<a style="font-size: 12px; size: 12px;" class="btn btn-default" href="index.php"><span class="glyphicon glyphicon-home"></span><span class="hidden-xs"> Retour</span></a>
		  </div>
        </div>
        <div class="panel-body">
            <div class="panel-log" id="panelLog">
				<ul class="list-group" id="groupLog" style="margin: 0%;">
				</ul>
			</div>
        </div>
      </div>
